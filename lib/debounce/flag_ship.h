...
class flag_ship
{
  ...
  void SetStateAndTime(uint8_t S = HIGH, unsigned long Time = 500) // 500 gives you enough time to be clicked about 3 times.
  {
    ...
    void SetDebounceTime(unsigned long Time = 15)
    {
      DBInterval = Time;
    }
